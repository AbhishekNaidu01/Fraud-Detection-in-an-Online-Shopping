  ...
  <div id="container"> 
    <div id="header"> 
      <div id="logo"><br>
        ...
        Fraud Detection System In Online Shopping <br>
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</font></strong></div>
    </div>
    <!-- /header -->
        ...
        <table height="350" align="center" width="700">
          <tr bgcolor="#CC3300"> 
            <td width="610" bgcolor="#FBF7E1">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
              ...
              Login</font></strong> <br><br><br> 
              <form name="s" action="seller_log1.jsp" method="get" onsubmit="return valid()">
    ...
    <div id="footer"> 
      ...
      <br>
      <br>
      <strong><font color="#33CC66">Copyrights-2018</font></strong> </div>
    <!-- /footer -->
  </div>
  <!-- /container -->
</div>
